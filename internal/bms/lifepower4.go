...
type LFP4AnalogValueBatteryInfo struct {
	...
	MaxCellVoltage    uint16     `name:"max_cell_voltage" dclass:"voltage" unit:"V" multiplier:"0.001" precision:"3"`
	MinCellVoltage    uint16     `name:"min_cell_voltage" dclass:"voltage" unit:"V" multiplier:"0.001" precision:"3"`
	CellVoltageDiff   uint16     `name:"diff_cell_voltage" dclass:"voltage" unit:"V" multiplier:"0.001" precision:"3"`
...
type LFP4AlarmInfo struct {
	...
	RemainingCapacityAlarm uint8     `name:"remaining_capacity_alarm" flags:"0x80,0x40,0x20,0x10,0x08,0x04,0x02,SOC low alarm"`
